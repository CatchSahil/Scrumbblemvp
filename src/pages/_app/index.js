      ...
      <Router>
        <>
          <Navbar
            color="navbar"
            spaced={true}
            logo="https://res.cloudinary.com/emishalabs/image/upload/v1568207525/scrumble_logo_d06zxg.png"
          />
          ...
          <Footer
            ...
            size="medium"
            logo="https://res.cloudinary.com/emishalabs/image/upload/v1568207525/scrumble_logo_d06zxg.png"
            description="Build your dream product"
            copyright="Copyright © 2019 Scrumble - A Venture of EmishaLabs "
          />
        </>
      </Router>
    </ProvideAuth>
